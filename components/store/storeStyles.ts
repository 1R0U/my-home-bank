...
export const storeStyles = StyleSheet.create({
  ...
  detailInfo: { flex: 1 },
  detailTitle: { color: "#fff8de", fontSize: 15, fontWeight: "900" },
  detailDescription: { color: "#c7bca8", fontSize: 11, fontWeight: "600", marginTop: 2 },
  detailMetaRow: {
    flexDirection: "row",
    gap: 12,
    marginTop: 6,
  },
  detailPrice: { color: "#f2c94c", fontSize: 13, fontWeight: "900" },
  detailStock: { color: "#c7bca8", fontSize: 12, fontWeight: "700" },
  footer: {
    alignItems: "center",
